  ...
  return (
    <div className="px-3 py-4 space-y-4 sm:px-4">
      <div className="flex items-center justify-between border-b border-border/60 pb-3">
        <div>
          <h1 className="text-base font-semibold tracking-tight sm:text-lg">Products</h1>
          <p className="text-xs text-muted-foreground">Finished product labels used across combinations</p>
        </div>
      ...
      {canEdit && (
        <div className="flex items-end gap-2 rounded-xl border border-border/70 bg-card p-3 shadow-sm">
      ...
      <div className="overflow-hidden rounded-xl border border-border/70 bg-card shadow-sm">
        ...
        <table className="w-full min-w-[420px] text-xs">
          ...
          <tbody>
            {rows.data?.map((r) => (
              <tr key={r.product_id} className="border-t border-border/60 transition-colors hover:bg-muted/30">
