  ...
  return (
    <div className="px-3 py-4 space-y-4 sm:px-4">
      ...
      <div className="rounded-xl border border-border/70 bg-card shadow-sm p-3 space-y-3">
        ...
        <div className="flex flex-wrap items-end gap-2 rounded-xl border border-border/70 bg-muted/20 p-3 shadow-sm">
        ...
        <div className="overflow-x-auto rounded-xl border border-border/70 shadow-sm">
          <table className="w-full min-w-[480px] text-xs">
            ...
            <tbody>
              {roles.data?.map((r) => (
                <tr key={r.id} className="border-t border-border/60 transition-colors hover:bg-muted/30">
