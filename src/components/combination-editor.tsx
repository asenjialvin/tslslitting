      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-md border">
            <div className="grid grid-cols-[1fr_1fr_70px_36px] gap-1 border-b bg-muted/40 px-2 py-1 text-[10px] uppercase tracking-wide text-muted-foreground">
              <div>Slit</div>
              <div>Product</div>
              <div>Count</div>
              <div />
            ...
            {lines.map((l, i) => (
              <div
                key={i}
                className="grid grid-cols-[1fr_1fr_70px_36px] gap-1 border-b px-2 py-1 last:border-b-0"
              >
                <Select
