    ...
    <div className="px-3 py-4 space-y-4 sm:px-4">
      <div className="flex items-center justify-between border-b border-border/60 pb-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground">Thickness &amp; width specifications</p>
        </div>
      ...
      <div className="overflow-hidden rounded-xl border border-border/70 bg-card shadow-sm">
        ...
        <table className="w-full min-w-[480px] text-xs">
          ...
          <tbody>
            {rows.data?.map((r) => (
              <tr key={r.spec_id} className="border-t border-border/60 transition-colors hover:bg-muted/30">
