...
export function FormulaBoxed({ combo }: { combo: CombinationDetail }) {
  ...
  return (
    <div className="flex flex-wrap items-stretch gap-1.5 text-[11px]">
      <div className="inline-flex items-center rounded-md border border-primary/40 bg-primary/5 px-2 py-1 font-mono tabular-nums">
      ...
      <div className="inline-flex items-center px-1 text-muted-foreground">⇒</div>
      <div className="inline-flex items-center rounded-md border border-success/40 bg-success/10 px-2 py-1 font-mono tabular-nums text-success">
        Total {fmtNum(total)}
      </div>
      <div className="inline-flex items-center rounded-md border border-warning/40 bg-warning/10 px-2 py-1 font-mono tabular-nums text-warning-foreground">
        Scrap {fmtNum(scrap)}
      </div>
    </div>
  );
