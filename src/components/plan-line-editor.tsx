...
export function PlanLineEditor({
  ...
  return (
    <div className="px-3 py-4 pb-24 space-y-4 sm:px-4">
      ...
      <div className="grid gap-3 lg:grid-cols-[minmax(0,320px)_1fr]">
        {/* LEFT: line meta */}
        <div className="space-y-2 rounded-xl border border-border/70 bg-card shadow-sm p-3">
          ...
          {preview && coil && (
            <div className="rounded-lg border border-border/70 bg-background p-2 text-[11px]">
          ...
          <Tabs value={mode} onValueChange={(v) => setMode(v as Mode)}>
            ...
            <TabsContent value="existing" className="m-0 p-3">
              {!coil ? (
                ...
                <p className="rounded-lg border border-border/70 bg-muted/30 p-2 text-[11px] text-muted-foreground">
      ...
      {/* Sticky footer */}
      <div className="fixed inset-x-0 bottom-0 z-40 border-t border-border/60 bg-background/95 shadow-[0_-4px_12px_-4px_rgba(0,0,0,0.08)] backdrop-blur">
